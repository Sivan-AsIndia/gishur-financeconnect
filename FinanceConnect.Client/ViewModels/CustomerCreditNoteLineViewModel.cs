...
{
    #region Model #30-Line: CustomerCreditNoteLine

    /// <summary>
    /// CustomerCreditNoteLine – One line item inside a CustomerCreditNote.
    /// Contains item/service details, quantities, prices, discounts, and taxes for credit.
    /// </summary>
    public class CustomerCreditNoteLineModel
    {
        ...
        /// <summary>FK → CustomerCreditNote - hidden</summary>
        ...
        /// <summary>FK → GLAccountMaster - Revenue Reversal Account, must be Active + Postable</summary>
        [Required(ErrorMessage = "Revenue Reversal Account is required")]
