...
{
    #region Model #28: CustomerInvoiceLine

    /// <summary>
    /// Model #28: CustomerInvoiceLine – One billable row inside a CustomerInvoice.
    /// The actual billing content - item/service details, quantities, prices, discounts, and taxes.
    /// </summary>
    public class CustomerInvoiceLineViewModel
    {
        ...
        /// <summary>FK → CustomerInvoice - hidden</summary>
        ...
        /// <summary>Description - max 500 chars, required if ItemId is null</summary>
        ...
        /// <summary>Discount Reason - optional, required if discount > policy threshold</summary>
        ...
        /// <summary>Rounding Adjustment - optional, handled at header normally</summary>
        ...
        /// <summary>Is System Generated - line inserted by automation (late fees, rounding)</summary>
        ...
        /// <summary>Service Period From - for service billing</summary>
        public DateTime? ServicePeriodFrom { get; set; }

        /// <summary>Service Period To - for service billing</summary>
    ...
    #region Line-related Enums and Static Classes
    ...
    public static class LineTypes
    {
        ...
        public static readonly string[] All = new[] { Item, Service, Charge, Manual };
